...
<script>
    ...
    import MediaQuery from "../MediaQuery.svelte";
	  import {categorie, csp_med, csp_moins, csp_plus, entre_16_25_ans, entre_26_45_ans, femme, homme, moins_15_ans, plus_46, products} from "$lib/store";
...
<div class="w3-content w3-padding" style="max-width:1564px">
    ...
    <div class="w3-container w3-content w3-center w3-padding-32" id="products">
        ...
        <div class="w3-row-padding ">
            ...
            <!-- {moyenne()}  -->
            {#each products as product}
                {#if (product.homme>=5) && (product.moins_15_ans<=3) && ((Math.abs((product.csp_moins-$csp_moins))+Math.abs((product.csp_med-$csp_med))+Math.abs((product.csp_plus-$csp_plus))+Math.abs((product.moins_15_ans-$moins_15_ans))+Math.abs((product.entre_16_25_ans-$entre_16_25_ans))+Math.abs((product.entre_26_45_ans-$entre_26_45_ans))+Math.abs((product.plus_46-$plus_46))+Math.abs((product.homme-$homme))+Math.abs((product.femme-$femme))))<=20}
                    <div class="w3-third w3-container w3-margin-bottom">
